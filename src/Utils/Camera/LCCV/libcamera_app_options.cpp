...
void Options::Print() const {
      ...
      std::cerr << "    photo resolution: " << photo_width << " x "
                << photo_height << std::endl;
      std::cerr << "    video resolution: " << video_width << " x "
                << video_height << std::endl;
      std::cerr << "    rawfull: " << rawfull << std::endl;
      std::cerr << "    transform: " << transformToString(transform)
                << std::endl;
      ...
      if (awb_gain_r && awb_gain_b)
            std::cerr << "    awb gains: red " << awb_gain_r << " blue "
                      << awb_gain_b << std::endl;
