...
enum ProjectIDs {
    ...
    // CalibrationPanel
    LC_CalibrationCamera_Button_ID,
    LC_CalibrationCapture_Button_ID,
    LC_ClearCalibration_Button_ID,
    LC_PreviewCamera_Button_ID,
    LC_PreviewCapture_Button_ID,
    ...
    LM_CalibrationCamera_Button_ID,
    LM_CalibrationCapture_Button_ID,
    LM_Remove_Button_ID,
    LM_PreviewCamera_Button_ID,
    LM_PreviewCapture_Button_ID,
